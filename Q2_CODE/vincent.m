function [dists, A12, A21] =  vincent(lat1, lon1, lat2, lon2)
...
a = 6378.1370;        % semi-major axis (km), GRS80
f = 1./298.2570222103; % flattening of the ellipsoid, GRS80
